                        ...
                        <tbody>
                            @foreach($requests as $key => $request)
                                <tr>
                                    ...
                                    <td>
                                        @if($request->status == 0)
                                            <a href="{{ url('/books/approved/request/'.$request->request_code.'/'.$request->book->book_code) }}" class="btn btn-success"><i class="fa fa-check"></i> Approved</a>
                                            <a href="{{ url('/books/decline/request/'.$request->request_code.'/'.$request->book->book_code) }}" class="btn btn-danger"><i class="fa fa-times"></i> Decline</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
